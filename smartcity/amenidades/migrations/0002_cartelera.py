# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-05 20:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creado_por', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='amenidades_cartelera_creados', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='amenidades_cartelera_modificados', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
